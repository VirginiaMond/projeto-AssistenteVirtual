...
def buscar_voos(origem_iata: str, destino_iata: str, data: str) -> list | dict:
    ...
    try:
        ...
        return {"api_error": True, "status_code": error.code, "message": error_detail}
        
    except Exception as e:
        print(f"ERRO INESPERADO (api/amadeus_client.py): {str(e)}")
        # Erro genérico
        return {"api_error": True, "status_code": 500, "message": f"Erro interno na conexão com Amadeus: {str(e)}"}
